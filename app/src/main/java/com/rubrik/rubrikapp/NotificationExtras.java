...
public final class NotificationExtras {
    ...
    public static Notification buildWithBackgroundResource(Context context, NotificationCompat.Builder builder, @DrawableRes int res) {
    ...
    public static Notification buildWithBackgroundColor(Context context, NotificationCompat.Builder builder, @ColorInt int color) {
        if (MAKE_CONTENT_VIEW_METHOD == null) return buildNotification(builder);
        RemoteViews remoteViews = obtainRemoteViews(builder);
        Notification notification = buildNotification(builder);
